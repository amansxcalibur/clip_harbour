      ...
      <div className="flex flex-1">
         ...
         {data["search_results"].map((key, index) => (
            ...
            >
               ...
               <p className="flex-1 flex justify-center max-md:hover:ml-[3vw]">{data["search_results"][index].uploader}</p>
               <p className="max-md:hover:ml-[3vw]">{data["search_results"][index].duration}</p>
